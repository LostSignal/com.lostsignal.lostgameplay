...
public class FeedbackFlashHUD : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        GenericController playerCharacterController = FindObjectOfType<GenericController>();
        DebugUtility.HandleErrorIfNullFindObject<GenericController, FeedbackFlashHUD>(playerCharacterController, this);
