            ...
            switch (message.GetId())
            {
                ...
                case UserInfoMessage.Id:
                {
                    ...
                    if (userInfoMessage.UserInfo.UserId != this.UserId)
                    {
                        if (this.printDebugOutput)
                        {
                            Debug.LogFormat($"GameClient: Received UserInfoMessage for {userInfoMessage.UserInfo}");
                        }
                    ...
                    else
                    {
                        if (this.printDebugOutput)
                        {
                            Debug.Log($"GameClient: Received UserInfoMessage For Myself {userInfoMessage.UserInfo}");
                        }
